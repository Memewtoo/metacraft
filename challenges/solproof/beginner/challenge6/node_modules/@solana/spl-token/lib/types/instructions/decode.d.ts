...
import { DecodedApproveInstruction } from '@solana/spl-token/lib/types/instructions/approve';
import { DecodedApproveCheckedInstruction } from '@solana/spl-token/lib/types/instructions/approveChecked';
import { DecodedBurnInstruction } from '@solana/spl-token/lib/types/instructions/burn';
import { DecodedBurnCheckedInstruction } from '@solana/spl-token/lib/types/instructions/burnChecked';
import { DecodedCloseAccountInstruction } from '@solana/spl-token/lib/types/instructions/closeAccount';
import { DecodedFreezeAccountInstruction } from '@solana/spl-token/lib/types/instructions/freezeAccount';
import { DecodedInitializeAccountInstruction } from '@solana/spl-token/lib/types/instructions/initializeAccount';
import { DecodedInitializeMintInstruction } from '@solana/spl-token/lib/types/instructions/initializeMint';
import { DecodedInitializeMultisigInstruction } from '@solana/spl-token/lib/types/instructions/initializeMultisig';
import { DecodedMintToInstruction } from '@solana/spl-token/lib/types/instructions/mintTo';
import { DecodedMintToCheckedInstruction } from '@solana/spl-token/lib/types/instructions/mintToChecked';
import { DecodedRevokeInstruction } from '@solana/spl-token/lib/types/instructions/revoke';
import { DecodedSetAuthorityInstruction } from '@solana/spl-token/lib/types/instructions/setAuthority';
import { DecodedSyncNativeInstruction } from '@solana/spl-token/lib/types/instructions/syncNative';
import { DecodedThawAccountInstruction } from '@solana/spl-token/lib/types/instructions/thawAccount';
import { DecodedTransferInstruction } from '@solana/spl-token/lib/types/instructions/transfer';
import { DecodedTransferCheckedInstruction } from '@solana/spl-token/lib/types/instructions/transferChecked';
/** TODO: docs */
